...
def enterinfo():
  ...
  txtpayslip.insert(END,"NI Number :\t\t"+IDNumber.get()+"\n\n")
...
lblIDDNumber=Label(fla,text="NI Number",font=('arial',16,'bold'),bd=20,fg="red",bg="powder blue").grid(row=1,column=2)
